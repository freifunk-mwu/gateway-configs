...
Das Repository wird durch ein Script aus unseren `backend-scripts <https://github.com/freifunk-mwu/backend-scripts>`_ befüllt, die *.yaml*-Dateien beeinflussen teilweise das Verhalten derer. Deshalb sind die Schreibrechte hier recht restriktiv.
